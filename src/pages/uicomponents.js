    ...
    <div>
      <div className="sidebar">
        ...
        <ul id="dynamic-tabs">
          ...
          <li
            className={currentPage === "maincomponent" && "activetab"}
            onClick={() => setCurrentPage("Maincomponent")}
          >
            Component
          </li>
          ...
          <li
            className={currentPage === "muibreadcrumbs" && "activetab"}
            onClick={() => setCurrentPage("muibreadcrumbs")}
          >
            Breadcrumbs
          </li>
          <li
          ...
          <li
            className={currentPage === "card" && "activetab"}
          ...
          {/* <li className={currentPage === "list" && "activetab"} onClick={() => setCurrentPage("list")} > List  </li> */}
          {/* <li className={currentPage === "menu" && "activetab"} onClick={() => setCurrentPage("menu")} > Menu  </li> */}
          <li
          ...
          <li
            className={currentPage === "stepper" && "activetab"}
            onClick={() => setCurrentPage("stepper")}
          >
            Stepper
          </li>
          <li
          ...
          <li
            className={currentPage === "muitabs" && "activetab"}
            onClick={() => setCurrentPage("muitabs")}
          >
            Tabs
          </li>
          <li
          ...
          <li
            className={currentPage === "transferlist" && "activetab"}
            onClick={() => setCurrentPage("transferlist")}
          >
            Transferlist
          </li>
          <li

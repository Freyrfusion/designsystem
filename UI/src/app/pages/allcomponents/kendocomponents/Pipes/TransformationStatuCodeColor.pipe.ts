...
export class TransformationStatuCodeColor implements PipeTransform {
    transform(value: string, tableName: string): string {
        ...
        if (tableName === 'kendotable') {
            if ('ILA' == value) {
                return temp + ' badge-success';
            } else if ('ILS' == value) {
                return temp + " badge-warning";
            }
            else if ('FSS' == value) { return temp + " badge-warning"; }
            else if ('FSA' == value) { return temp + " badge-primary"; }
            else if ('FSN' == value) { return temp + " badge-light"; }
            else if ('FMC' == value) { return temp + " badge-info"; }
            else {
